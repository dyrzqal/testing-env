            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ number_format($dashboardData['inProgressReports']) }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ number_format($dashboardData['resolvedReports']) }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                @forelse($dashboardData['reportsByCategory'] as $categoryData)
                    <div class="p-4 bg-gray-50 rounded-lg">
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-900">
                                {{ $categoryData->category->name ?? 'Uncategorized' }}
                            </span>
                            <span class="text-lg font-semibold text-blue-600">{{ $categoryData->count }}</span>
                        </div>
                    </div>
                @empty
                    <p class="text-sm text-gray-500 col-span-full text-center py-4">No category data available</p>
                @endforelse
            </div>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ route('admin.reports.index', ['status' => 'pending']) }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Review new reports</p>
                    </div>
                </a>
                
                <a href="{{ route('admin.categories.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <svg class="h-6 w-6 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                    </svg>
                    <div>
                        <p class="text-sm font-medium text-gray-900">Manage Categories</p>
                        <p class="text-xs text-gray-500">Organize report types</p>
                    </div>
                </a>
